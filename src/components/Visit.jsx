...
export default function Visit() {
  ...
  return (
    <section id="visit" className="overflow-hidden bg-white py-24 text-charcoal sm:py-36">
      <div className="container-khem">
        ...
        <div className="mb-14">
          ...
          <motion.p
            className="mt-4 max-w-md font-sans text-base text-charcoal/60"
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <div className="flex gap-4">
              ...
              <div className="font-sans text-sm leading-relaxed text-charcoal/70">
                <p className="mb-1 font-medium text-charcoal">Khem Tattoo &amp; Piercing</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                href={site.phoneHref}
                className="flex items-center justify-center gap-2.5 rounded-full bg-charcoal px-7 py-4 font-sans text-[13px] font-medium uppercase tracking-wide2 text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-black"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2.5 rounded-full border border-charcoal/30 px-7 py-4 font-sans text-[13px] uppercase tracking-wide2 text-charcoal transition-all duration-300 hover:border-charcoal hover:bg-charcoal/5"
