...
export default function WhyKhem({ service = "tattoo" }) {
  ...
  return (
    <section id="why-khem" className="bg-[#f7f7f5] py-20 text-black sm:py-24">
      <div className="container-khem">
        ...
        <p className="mt-5 max-w-3xl text-sm leading-6 text-black/70">
          {isPiercing
            ? "Every piercing is planned around your anatomy, comfort and personal style. We combine precise placement, sterile technique and thoughtful jewellery choices for a result that looks beautiful and heals safely."
            : "Every tattoo is more than just ink — it's a story, your story. We blend artistry, precision and safety to create work you'll be proud of, forever."}
        </p>
