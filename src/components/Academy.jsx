        ...
        <div className="container-khem">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-2">
            {courses.map((course) => (
              <article
                key={course.number}
                className="group relative overflow-hidden border border-charcoal/15 bg-ivory p-7 transition-all duration-300 hover:-translate-y-1 hover:border-charcoal/30 hover:shadow-[0_16px_40px_rgba(34,30,27,0.12)] sm:p-10"
              >
                <div className="absolute left-0 top-0 h-full w-1 bg-gold/60 transition-colors duration-300 group-hover:bg-gold" />
                ...
                <p className="mt-4 font-mono text-[11px] uppercase tracking-wide2 text-charcoal/55">{course.duration} · By application</p>
                <p className="mt-7 max-w-md font-sans text-sm leading-relaxed text-charcoal/70">{course.text}</p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-7 inline-flex rounded-full border border-charcoal/20 bg-charcoal px-6 py-2.5 font-sans text-[11px] font-bold uppercase tracking-wide2 text-bone transition-all duration-300 hover:-translate-y-0.5 hover:bg-charcoal/90"
                >
                  Enquire 
                </a>
              </article>
